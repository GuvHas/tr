...
To avoid a GCC 14 + `gnu++2b` incompatibility in transitive connectedhomeip closure-control sources, the project forces C++17 and explicitly strips any `-std=gnu++2b` flag injected into the `__idf_espressif__esp_matter` target during configure.
